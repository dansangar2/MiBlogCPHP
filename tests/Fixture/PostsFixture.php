...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tittle' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'posts_ibfk_2' => ['type' => 'foreign', 'columns' => ['category_id'], 'references' => ['categories', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2023-11-24 12:17:16',
                'modified' => '2023-11-24 12:17:16',
                'user_id' => 1,
                'category_id' => 1,
            ],
        ];
